...
type Take = { id: string; mediaKind: string | null; fileUrl: string | null; localPath: string | null; versionNumber: number; status: string; createdAt: string };
type Shot = { id: string; order: number; title: string | null; status: string; sourceImagePath: string | null; motionPrompt: string | null; previewVideoPath: string | null; finalVideoPath: string | null; jobs: Job[]; takes: Take[] };
