  ...
  return <div className="flex flex-col gap-3">
    ...
    <form ref={formRef} onSubmit={async (event) => {
      ...
      try {
        ...
        setReport(data); if (data.successes.length > 0) formRef.current?.reset();
